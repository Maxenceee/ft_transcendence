								...
								class: "friend-search", style: (this.state.open ? "width: 280px" : ""), children: [
									this.state.open && createElement('div', {
										class: "friend-search-header", children: [
											createElement('div', {
												class: "friend-search-icon", style: (this.state.onsearch ? "color: var(--friend-bg)" : ""), onclick: () => this.setState({onsearch: !this.state.onsearch, search: ""}), children: createElement('svg', {
