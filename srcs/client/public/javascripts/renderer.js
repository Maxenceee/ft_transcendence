...
class UserPagePlayerHistory extends Component {
	...
	render() {
		...
		return createElement('div', {children: [
			createElement('button', {onclick: this.onClick.bind(this), children:
				"Reload"
			}),
			createElement('div', {
...
class Main extends Component {
    ...
    render() {
		...
		return (
			this.state.loading ?
			createElement('div', {children: "Loading"})
			:
