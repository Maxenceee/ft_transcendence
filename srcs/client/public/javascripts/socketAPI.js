 ...
 * DEMO USAGE:
 * 
 * To include this file in your project, just add the following line in your HTML file:
 * <script src="path/to/socketAPI.js"></script>
 * The script tag need to be added before yours and will be available in the global
 * scope as "Socket"
 * 
 ****************************************************************************************/


// create new socket using "/socket" path (see server side for more details on pathing)
let socket = new Socket({path: "/socket"});

// your callback function, it wee be called when the socket receive a message
let functionToCall = function(data) {
	console.log(data);
}

// use the callback function on ths socket
...
// you can also use the onconnection and onclose methods
socket.onconnection(() => {
...
socket.send({type: "message", data: "Hello World"});
